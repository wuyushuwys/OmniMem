...
class WanUpsample(nn.Upsample):
    r"""Upsample while preserving the input dtype."""
...
class AutoencoderKLWan(ModelMixin, ConfigMixin, FromOriginalModelMixin):
    ...
    def __init__(
        ...
        self.temporal_downscale_factor = 4
    ...
    def encode(
        ...
        Args:
            ...
            return_dict (`bool`): If True, return `AutoencoderKLOutput`; else return a plain tuple.
        """
        h = self._encode(x)
    ...
    def streaming_decode(self, z: torch.Tensor, return_dict: bool = True) -> Union[DecoderOutput, torch.Tensor]:
    ...
    def decode(self, z: torch.Tensor, return_dict: bool = True) -> Union[DecoderOutput, torch.Tensor]:
        ...
        Args:
            ...
            return_dict (`bool`): If True, return `DecoderOutput`; else return a plain tuple.
        """
    ...
    def forward(
        ...
        Args:
            ...
            return_dict (`bool`): If True, return a `DecoderOutput` instead of a plain tuple.
        """
        x = sample
